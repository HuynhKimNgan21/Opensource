<?php
namespace Magento\Sales\Controller\Adminhtml\Shipment\Pdfshipments;

/**
 * Interceptor class for @see \Magento\Sales\Controller\Adminhtml\Shipment\Pdfshipments
 */
class Interceptor extends \Magento\Sales\Controller\Adminhtml\Shipment\Pdfshipments implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function massAction(\Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection $collection)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('massAction', func_get_args(), $pluginInfo) : parent::massAction($collection);
    }
