...
class Interceptor extends \Magento\OfflineShipping\Model\ResourceModel\Carrier\Tablerate\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setWebsiteFilter');
        return $pluginInfo ? $this->___callPlugins('setWebsiteFilter', func_get_args(), $pluginInfo) : parent::setWebsiteFilter($websiteId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setConditionFilter');
        return $pluginInfo ? $this->___callPlugins('setConditionFilter', func_get_args(), $pluginInfo) : parent::setConditionFilter($conditionName);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setCountryFilter');
        return $pluginInfo ? $this->___callPlugins('setCountryFilter', func_get_args(), $pluginInfo) : parent::setCountryFilter($countryId);
    }
